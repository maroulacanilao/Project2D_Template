...
public enum Month { January = 1, February = 2, March = 3, April = 4, May = 5, June = 6, 
...
public class TimeManager : Singleton<TimeManager>
{
    ...
    public static void StartDay(bool startTimePaused)
    {
        ...
        if(prevDateTime.Month != DateTime.Month) OnNewMonth.Invoke(Instance);
    }

    public static void PauseTime(bool freezeTimescale = true) 
    {
